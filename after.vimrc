...
noremap <silent> <leader>fq :quit!<cr>
...
"" NERDTree
nmap <F8> :NERDTreeClose<CR>:NERDTree <c-r>=expand("%:p:h")<CR><CR>
nmap <C-n> :NERDTreeClose<CR>:NERDTree <c-r>=expand("%:p:h")<CR><CR>

"" tagbar
map <leader><leader> :TagbarOpen<CR>
...
if has('win32')
    let g:cscope_bin= '"'.$HOME.'\vimfiles\bins\cscope.exe"'
    let g:FindCmd = '"'.$HOME.'\vimfiles\bins\wfind.exe"'
